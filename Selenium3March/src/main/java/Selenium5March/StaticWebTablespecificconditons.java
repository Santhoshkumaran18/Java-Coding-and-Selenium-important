...
public class StaticWebTablespecificconditons {
	public static void main(String[] args) {
		...
		for (int i = 1; i < totalrowsincHeaders.size(); i++) {
			...
			String AuthorName = driver
					.findElement(By.xpath("//table[@name='BookTable']/tbody/tr[" + (i + 1) + "]/td[2]")).getText();
			if (AuthorName.equals("Mukesh")) {
				String bookname = driver
						.findElement(By.xpath("//table[@name='BookTable']/tbody/tr[" + (i + 1) + "]/td[1]")).getText();
